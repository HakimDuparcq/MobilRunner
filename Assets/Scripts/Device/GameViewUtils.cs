...
public static class GameViewUtils
{
    ...
    //Hakim
    [MenuItem("GameView Size/Phone Size")]
    public static void GameViewPhone1()
    {
        SetSize(11);
    }

    [MenuItem("GameView Size/MapEditor Size")]
    public static void GameViewPhone2()
    {
        SetSize(8);
    }
    ...
    {
        int idx = FindSize(GameViewSizeGroupType.Standalone, 100, 100);
        Debug.Log(idx);
        if (idx != -1)
            SetSize(idx);
    }*/
